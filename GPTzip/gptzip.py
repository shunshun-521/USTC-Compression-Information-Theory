...
class GPTZip:
    def __init__(self):
        ...
        self.BATCH_SIZE = 10
        self.model = GPT2LMHeadModel.from_pretrained("C:/Users/28624/Informationtheory/Compression/gpt2_medium_models")
        self.tokenizer = AutoTokenizer.from_pretrained("C:/Users/28624/Informationtheory/Compression/gpt2_medium_models")
    ...
    def zip_file(self, text_file, zip_file):
        with open(text_file, encoding="latin-1", newline="") as f:
            text = f.read()
    ...
    def unzip_file(self, zip_file, text_file):
        ...
        with open(text_file, "w", encoding="latin-1", newline="") as f:
            f.write(text)
