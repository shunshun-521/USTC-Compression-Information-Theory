...
from simulation import env_int, run_simulation
from utils import (
    find_capacity_limit,
    plot_bler_curves,
...
def run_unit_tests():
    ...
    for _ in range(100):
        ...
        assert np.array_equal(u_hat[info_idx], u_msg[info_idx])
...
def main():
    ...
    EB_N0_RANGE = np.arange(0.0, 5.5, 0.5 if os.environ.get("POLAR_QUICK") == "1" else 0.25)
