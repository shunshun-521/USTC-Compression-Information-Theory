...
N_LIST = cfg.EXP1_N_LIST
RATE = cfg.RATE
DESIGN_EBN0 = cfg.DESIGN_EBN0
MAX_FRAMES = cfg.EXP1_MAX_FRAMES
MIN_ERRORS = cfg.EXP1_MIN_ERRORS
EB_N0_RANGE = (
    cfg.EXP1_EB_N0 if cfg.EXP1_EB_N0 is not None else np.arange(0.0, 5.5, 0.25)
)
