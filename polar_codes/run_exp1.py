...
from simulation import is_fast_sim, run_simulation
...
RATE = 0.5
DESIGN_EBN0 = 2.5
MAX_FRAMES = 500 if is_fast_sim() else 100000
MIN_ERRORS = 10 if is_fast_sim() else 100
EB_N0_RANGE = np.arange(1.0, 4.0, 0.5) if is_fast_sim() else np.arange(0.0, 5.5, 0.25)
