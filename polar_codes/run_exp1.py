...
from validate import test_encoder, test_sc_noiseless, test_sc_low_noise
...
N_LIST = [128, 256] if FAST else [256, 512, 1024]
RATE = 0.5
DESIGN_EBN0 = 2.5
MAX_FRAMES = 500 if FAST else 100000
MIN_ERRORS = 10 if FAST else 100
EB_N0_RANGE = np.arange(3.0, 7.0, 1.0) if FAST else np.arange(0.0, 5.5, 0.25)
