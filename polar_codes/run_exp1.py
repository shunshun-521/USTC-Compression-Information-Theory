...
for _ in range(100):
    ...
    if not np.array_equal(sc_decode(llr, frozen_t), uu):
        err += 1
...
RATE = 0.5
DESIGN_EBN0 = 2.5
MAX_FRAMES = 800 if QUICK else 100000
MIN_ERRORS = 20 if QUICK else 100
EB_N0_RANGE = np.arange(0.0, 5.5, 0.5) if QUICK else np.arange(0.0, 5.5, 0.25)
