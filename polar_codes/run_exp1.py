...
def run_unit_tests():
    ...
    for _ in range(100):
        ...
        assert np.array_equal(u, u_hat), "SC 译码在 Eb/N0=10dB 下应无错误"
    ...
    print("GA N=256,K=128 first 20 info:", info256[:20])
    print("单元测试通过。")
...
def main():
    ...
    save_frozen_set_info(N_LIST, int(N_LIST[0] * RATE), DESIGN_EBN0, "results/frozen_sets.txt")
