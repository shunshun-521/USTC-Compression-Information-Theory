...
def run_unit_tests():
    ...
    from channel import bpsk_modulate, compute_llr, eb_n0_to_sigma, permute_llr_for_decoder
    from construction import ga_construction as gc

    N, K = 64, 32
    info_idx, _, _ = gc(N, K, 2.5)
    ...
    for _ in range(100):
        ...
        llr = permute_llr_for_decoder(compute_llr(y, sigma), N)
