...
N_LIST = [256, 512] if os.environ.get('POLAR_FAST_SIM') == '1' else [256, 512, 1024]
RATE = 0.5
DESIGN_EBN0 = 2.5
EB_N0_RANGE = np.arange(1.0, 4.5 + sim['eb_step'], sim['eb_step'])
...
for N in N_LIST:
    ...
    results = run_simulation(
        ...
        decoder_type='sc', info_indices=info_idx,
...
plot_bler_curves(all_results, f'SC Decoder BLER vs Eb/N0 (R={RATE})',
