...
def run_unit_tests():
    ...
    for _ in range(100):
        ...
        if not np.array_equal(u_hat[info_idx], u_t[info_idx]):
            errors += 1
    assert errors == 0, f"SC 译码在 Eb/N0=10dB 下失败 {errors}/100 帧"

    info8, frozen8, _ = ga_construction(8, 4, 2.5)
    print("验证 N=8, K=4:", info8, frozen8)
    info256, _, _ = ga_construction(256, 128, 2.5)
    print("验证 N=256 前20信息位:", info256[:20])


N_LIST = [128] if QUICK else [256, 512, 1024]
RATE = 0.5
DESIGN_EBN0 = 2.5
