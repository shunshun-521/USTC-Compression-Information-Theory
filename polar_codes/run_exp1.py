...
verify_sc_decoder(N=64, K=32, num_frames=100, eb_n0_db=10.0)
print("单元测试通过\n")
...
for N in N_LIST:
    ...
    frozen_bits_arr = np.ones(N, dtype=int)
    frozen_bits_arr[info_idx] = 0
    frozen_bool = frozen_bits_arr.astype(bool)

    def decoder(llr_ch, _fb=frozen_bool):
