...
_validate.test_construction()
_validate.test_crc()
_validate.test_sc_recursive_match()
_validate.test_sc_lossless()
_validate.test_scl_equiv_sc()
...
EB_N0_MAX = float(os.environ.get("POLAR_EB_MAX", "5.5"))
EB_N0_STEP = float(os.environ.get("POLAR_EB_STEP", "0.25"))

N_LIST = [256, 512]
if not os.environ.get("POLAR_SKIP_N1024"):
    N_LIST.append(1024)
if os.environ.get("POLAR_N256_ONLY"):
    N_LIST = [256]
