...
save_frozen_set_info(
    N_LIST, None, DESIGN_EBN0,
    os.path.join(os.path.dirname(__file__), 'results/frozen_sets.txt'),
)
...
for N in N_LIST:
    ...
    save_results_csv(results, os.path.join(os.path.dirname(__file__), f'results/exp1_sc_N{N}_R0.5.csv'))
...
plot_bler_curves(
    ...
    save_path=os.path.join(os.path.dirname(__file__), 'results/fig1_sc_bler.png'),
