...
from simulation import apply_fast_sim_defaults, run_simulation
...
RATE = 0.5
DESIGN_EBN0 = 2.5
MAX_FRAMES, MIN_ERRORS = apply_fast_sim_defaults()
EB_N0_RANGE = np.arange(0.0, 5.5, 0.25)
if os.environ.get("POLAR_FAST_SIM", "").lower() in ("1", "true", "yes"):
    EB_N0_RANGE = np.arange(1.0, 4.0, 0.5)

save_frozen_set_info(N_LIST, lambda n: n // 2, DESIGN_EBN0, "results/frozen_sets.txt")
