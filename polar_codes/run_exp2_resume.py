...
all_results = {
    "SC (L=1)": load_results_csv(f"results/exp2_sc_N{N}_R0.5.csv"),
    "SCL (L=2)": load_results_csv(f"results/exp2_scl_L2_N{N}_R0.5.csv"),
    "SCL (L=4)": load_results_csv(f"results/exp2_scl_L4_N{N}_R0.5.csv"),
}
