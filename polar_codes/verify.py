...
def test_ga_construction():
    ...
    exp20 = [1, 2, 4, 7, 8, 11, 13, 14, 16, 19, 21, 22, 25, 26, 28, 31, 32, 35, 37, 38]
    assert np.array_equal(info256[:20], exp20), f"GA N=256 前20错误: {info256[:20]}"
    print("✓ GA 构造校验通过")
