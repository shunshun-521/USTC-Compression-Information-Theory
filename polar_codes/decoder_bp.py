...
class BPDecoder:
    ...
    def decode(self, llr_ch):
        ...
        llr_dec = _reorder_llr_for_decode(llr_natural)
        n = self.n
        N = self.N
        LARGE = 1e6
            ...
            for j in range(n - 1, -1, -1):
                ...
                for i in range(0, N, 2 * s):
                    for k in range(s):
                        u = i + k
                        l = i + k + s
                        L[u, j] = self._minsum_f(R[u, j] + L[l, j + 1], L[u, j + 1])
                        L[l, j] = self._minsum_f(R[u, j], L[u, j + 1]) + L[l, j + 1]
            ...
            for j in range(0, n):
                ...
                for i in range(0, N, 2 * s):
                    for k in range(s):
                        u = i + k
                        l = i + k + s
                        R[u, j + 1] = self._minsum_f(R[l, j] + L[l, j + 1], R[u, j])
                        R[l, j + 1] = self._minsum_f(R[u, j], L[u, j + 1]) + R[l, j]
