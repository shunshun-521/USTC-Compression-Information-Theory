...
from channel import hard_decision
...
class BPDecoder:
    ...
    def decode(self, llr_ch):
        ...
        for it in range(1, self.max_iter + 1):
            for j in range(n, 0, -1):
                ...
                for i in range(0, N, 2 * s):
                    for k in range(s):
                        ...
                        L[idx + s, j - 1] = (
                            self._f_min_sum(R[idx, j - 1], L[idx, j]) + L[idx + s, j]
                        )
            ...
            for j in range(0, n):
                ...
                for i in range(0, N, 2 * s):
                    for k in range(s):
                        ...
                        R[idx + s, j + 1] = (
                            self._f_min_sum(R[idx, j], L[idx, j + 1]) + R[idx + s, j]
                        )
            ...
            if np.array_equal(x_hat, hard_decision(llr_perm)):
                num_iters = it
                break
