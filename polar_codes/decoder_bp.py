...
class BPDecoder:
    ...
    def decode(self, llr_ch):
        ...
        L[:, n] = _channel_llr_layout(llr_ch)
        R[:, 0] = 0.0
                ...
                for i in range(0, N, 2 * s):
                    for k in range(s):
                        ...
                        L[Li, j - 1] = self._minsum(
                            R[Li, j - 1] + L[Lis, j], L[Li, j]
                        )
                        L[Lis, j - 1] = (
                            self._minsum(R[Li, j - 1], L[Li, j]) + L[Lis, j]
                        )
                ...
                for i in range(0, N, s):
                    for k in range(half):
                        ...
                        R[Li, j + 1] = self._minsum(
                            R[Lis, j + 1] + L[Lis, j + 1], R[Li, j]
                        )
                        R[Lis, j + 1] = (
                            self._minsum(R[Li, j], L[Li, j + 1]) + R[Lis, j]
                        )
