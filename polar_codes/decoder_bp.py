        ...
        for it in range(1, self.max_iter + 1):
            ...
            for j in range(n, 0, -1):
                ...
                for i in range(0, N, 2 * step):
                    ...
                    L[left, j - 1] = _boxplus_minsum(
                        R[left, j] + L[right, j], L[left, j], alpha
                    )
                    L[right, j - 1] = _boxplus_minsum(
                        R[left, j], L[left, j], alpha
                    ) + L[right, j]
            ...
            for j in range(0, n):
                ...
                for i in range(0, N, 2 * step):
                    left = slice(i, i + step)
                    right = slice(i + step, i + 2 * step)
                    R[left, j + 1] = _boxplus_minsum(
                        R[right, j] + L[right, j + 1], R[left, j], alpha
                    )
                    R[right, j + 1] = _boxplus_minsum(
                        R[left, j], L[right, j + 1], alpha
                    ) + R[right, j]
