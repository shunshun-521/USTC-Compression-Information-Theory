...
def test_encoder():
    ...
    assert np.array_equal(x, x_mat), f"Encoder/matrix mismatch: {x} vs {x_mat}"
...
def test_sc_lossless():
    ...
    for _ in range(100):
        ...
        u[info_idx] = payload
        x = polar_encode(u)
        y = awgn_channel(bpsk_modulate(x), sigma * 0.01, rng)
...
def test_sc_recursive_match():
    ...
    for _ in range(20):
        ...
        assert np.array_equal(u1, u2), "Recursive/non-recursive SC mismatch"
