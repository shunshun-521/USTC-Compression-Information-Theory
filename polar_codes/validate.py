...
def test_ga_construction():
    ...
    print("GA construction test passed")
...
def test_sc_lossless():
    ...
    print("SC lossless test passed (100 frames)")
...
def test_sc_recursive_match():
    ...
    print("SC recursive vs non-recursive match passed")
...
def test_bp_roundtrip():
    ...
    for _ in range(50):
        ...
        if np.array_equal(u_hat[info_idx], u[info_idx]):
            ok += 1
    print(f"BP high-SNR test: {ok}/50 correct")
