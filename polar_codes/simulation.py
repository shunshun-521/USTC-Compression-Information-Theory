...
def run_simulation(
    ...
    蒙特卡洛仿真。
    """
    if os.environ.get("POLAR_MAX_FRAMES"):
        max_frames = int(os.environ["POLAR_MAX_FRAMES"])
    if os.environ.get("POLAR_MIN_ERRORS"):
        min_errors = int(os.environ["POLAR_MIN_ERRORS"])
