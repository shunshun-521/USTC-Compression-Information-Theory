    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            if crc_length > 0:
                ...
                err = not np.array_equal(u_hat[payload_idx], info_payload)
                bit_err = np.sum(u_hat[payload_idx] != info_payload)
            else:
                err = not np.array_equal(u_hat[info_indices], coded_info)
                bit_err = np.sum(u_hat[info_indices] != coded_info)
