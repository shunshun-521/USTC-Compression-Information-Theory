    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            if crc_length > 0:
                ...
                frame_error = not crc_check_frame(decoded_info, info_payload, crc_length)
...
def crc_check_frame(decoded_info, info_payload, crc_length):
    from decoder_scl import crc_check

    return crc_check(decoded_info, crc_length) and np.array_equal(
        decoded_info[: len(info_payload)], info_payload
    )
