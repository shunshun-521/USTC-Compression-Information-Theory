...
def run_simulation(
    ...
    if os.environ.get("POLAR_QUICK") == "1":
        max_frames = _env_int("POLAR_MAX_FRAMES", min(max_frames, 2000))
        min_errors = _env_int("POLAR_MIN_ERRORS", min(min_errors, 20))
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            bit_err = int(np.count_nonzero(sent_info != recv_info))
