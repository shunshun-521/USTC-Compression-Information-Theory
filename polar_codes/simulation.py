...
from construction import ga_construction, ga_construction_validated
...
def run_simulation(
    ...
    if info_indices is None or frozen_bits is None:
        info_indices, frozen_indices, _ = ga_construction_validated(
            N, K, design_eb_n0_db
        )
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            if crc_length > 0:
                ...
                frame_error = not np.array_equal(decoded_info[:K_info], info_payload)
