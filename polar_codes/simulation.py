...
def run_simulation(
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            compare_len = k_info if crc_length > 0 else K
            if crc_length > 0:
                sent_bits = payload_with_crc[:compare_len]
                recv_bits = u_hat[info_indices][:compare_len]
            else:
                sent_bits = info_payload
                recv_bits = u_hat[info_indices]
        ...
        ber = num_bit_errors / (num_frames * (k_info if k_info > 0 else K))
