...
def run_simulation(
    ...
    k_info = K - crc_length
    info_payload_idx = info_indices[:k_info] if crc_length > 0 else info_indices
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            y = awgn_channel(symbols, sigma, rng=rng)
            ...
            payload_hat = u_hat[info_payload_idx]
            payload_sent = info_bits[:k_info]
