...
def run_simulation(
    ...
    if frozen_bits is None or info_indices is None:
        design_eb_n0 = float(os.environ.get("POLAR_DESIGN_EBN0", "2.5"))
        info_indices, _, _ = ga_construction(N, K, design_eb_n0)
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            if crc_length > 0:
                ...
                frame_error = not crc_check_safe(decoded_info, crc_length)
