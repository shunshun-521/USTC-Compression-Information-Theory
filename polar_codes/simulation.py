...
def run_simulation(
    ...
    if info_indices is None:
        info_indices = np.sort(np.arange(N)[-K:])  # fallback, should pass explicit indices
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            payload_hat = u_hat[info_indices][:K_payload]
            bit_err = np.count_nonzero(payload_hat != payload)
        ...
        ber = num_bit_errors / (num_frames * K_payload) if num_frames else 0.0
