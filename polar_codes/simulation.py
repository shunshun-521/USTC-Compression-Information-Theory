    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            if crc_length > 0:
                ...
                u[info_indices[: len(coded)]] = coded
            else:
            ...
            if crc_length > 0:
                payload_hat = u_hat[info_indices[:K]]
                from decoder_scl import crc_check

                frame_error = not crc_check(payload_hat, crc_length)
                compare_len = k_info
            else:
            ...
            if frame_error:
                num_errors += 1
                num_bit_errors += np.sum(u_hat[info_indices[:compare_len]] != payload)
