    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            if crc_length > 0:
                ...
                msg = rng.integers(0, 2, size=k_info)
            ...
            if crc_length > 0:
                num_bit_errors += np.count_nonzero(msg != u_hat[info_indices][:k_info])
            else:
                num_bit_errors += np.count_nonzero(payload != u_hat[info_indices])
