...
def run_simulation(
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            if crc_length > 0:
                check_bits = u[info_indices[:K_info + crc_length]]
                hat_bits = u_hat[info_indices[:K_info + crc_length]]
            else:
                check_bits = info_bits
                hat_bits = u_hat[info_indices]

            bit_err = np.sum(check_bits[:K_info] != hat_bits[:K_info])
