...
def run_simulation(
    ...
    """
    蒙特卡洛仿真。
    可传入 info_indices / frozen_bits；否则用 GA 构造。
    """
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            compare_hat = u_hat[info_indices][:k_info]
            frame_err = not np.array_equal(compare_hat, compare_bits)
            bit_err = np.sum(compare_hat != compare_bits)
