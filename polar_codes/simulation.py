...
def run_simulation(
    ...
    if max_frames is None or min_errors is None:
        dmax, dmin = _sim_params()
        max_frames = max_frames if max_frames is not None else dmax
        min_errors = min_errors if min_errors is not None else dmin
