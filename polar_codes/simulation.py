...
def run_simulation(
    ...
    if info_indices is None:
        raise ValueError("info_indices must be provided for BER counting")

    k_info = K - crc_length
    info_set = set(info_indices.tolist())

    for snr_idx, eb_n0_db in enumerate(eb_n0_db_list):
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            sent_info = u[list(info_indices)]
            recv_info = u_hat[list(info_indices)]
