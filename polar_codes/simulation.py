...
from channel import (
    bpsk_modulate, awgn_channel, compute_llr, eb_n0_to_sigma,
    permute_llr_for_decoder,
)
...
def run_simulation(
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            llr = permute_llr_for_decoder(llr_ch, N)
            ...
            if not np.array_equal(u_sent_info, u_hat_info):
                num_errors += 1
                num_bit_errors += np.sum(u_sent_info != u_hat_info)
