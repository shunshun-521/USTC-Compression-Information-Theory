...
def run_simulation(
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            if crc_length > 0:
                ber_bits_sent = sent_info[:K_info]
                ber_bits_dec = decoded_info[:K_info]
            else:
                ber_bits_sent = sent_info
                ber_bits_dec = decoded_info

            bit_err = int(np.sum(ber_bits_dec != ber_bits_sent))
