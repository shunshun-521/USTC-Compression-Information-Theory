...
def run_simulation(
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            if crc_length > 0:
                frame_info_sent = info_bits
                frame_info_hat = u_hat[info_indices][:k_info]
            else:
                frame_info_sent = payload
                frame_info_hat = u_hat[info_indices]

            bit_err = np.sum(frame_info_hat != frame_info_sent)
