...
def _sim_params():
    ...
    if fast:
        max_frames = int(os.environ.get("POLAR_MAX_FRAMES", "200"))
        min_errors = int(os.environ.get("POLAR_MIN_ERRORS", "5"))
...
def run_simulation(
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            # 比较信息位（不含 CRC）
            u_info_sent = u[info_indices][:K_info]
