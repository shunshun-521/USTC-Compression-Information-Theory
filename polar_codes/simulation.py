...
def run_simulation(
    ...
    if info_indices is None:
        info_indices, _, _ = __import__(
            "construction", fromlist=["ga_construction"]
        ).ga_construction(N, K, 2.5)
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        ber = (
            num_bit_errors / (num_frames * K_info) if num_frames > 0 and K_info > 0 else 1.0
        )
