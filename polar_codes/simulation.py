...
def run_simulation(
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            llr_ch = reorder_llr_for_decode(compute_llr(y, sigma), N)
            ...
            if crc_length > 0:
                compare_len = k_info
                sent_compare = sent_info[:compare_len]
                recv_compare = recv_info[:compare_len]
            else:
                sent_compare = sent_info
                recv_compare = recv_info

            bit_err = np.sum(sent_compare != recv_compare)
