...
from channel import bpsk_modulate, awgn_channel, compute_llr, bit_reverse_llr
...
def run_simulation(
    ...
    for eb_n0_db in eb_n0_db_list:
        sigma = eb_n0_to_sigma_import(eb_n0_db, rate)
        num_errors = 0
        num_bit_errors = 0
        num_frames = 0
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            llr_ch = bit_reverse_llr(llr_raw)
...
def eb_n0_to_sigma_import(eb_n0_db, rate):
    from channel import eb_n0_to_sigma

    return eb_n0_to_sigma(eb_n0_db, rate)
