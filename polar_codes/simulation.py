...
def run_simulation(
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            if crc_length > 0:
                sent_payload = crc_encode(info_bits, crc_length)
            else:
                sent_payload = info_bits

            frame_error = not np.array_equal(decoded_info, sent_payload)
        ...
        ber = num_bit_errors / (num_frames * (K - crc_length)) if num_frames else 0.0
