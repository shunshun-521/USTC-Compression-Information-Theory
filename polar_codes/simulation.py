...
def run_simulation(
    ...
    返回：dict 列表，每个 Eb/N0 点包含 bler, ber, num_errors, num_frames,
    ...
    if info_indices is None:
        info_indices = np.where(np.ones(N, dtype=int) == 0)[0]  # placeholder
