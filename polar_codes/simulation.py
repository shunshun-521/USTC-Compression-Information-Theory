...
def run_simulation(
    ...
    if info_indices is None:
        info_indices = np.arange(N)  # fallback
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            # Compare info bits (excluding CRC for BER denominator handled below)
            u_info_sent = payload[:K_info] if crc_length > 0 else info_bits
