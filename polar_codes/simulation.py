    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            if crc_length > 0:
                ...
                got_info = u_hat[info_indices]
                frame_error = not np.array_equal(got_info, sent_info)
                bit_err = np.sum(got_info != sent_info)
