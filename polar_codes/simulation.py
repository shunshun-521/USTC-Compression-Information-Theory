...
def run_simulation(
    ...
    if info_indices is None:
        ...
        info_positions = np.asarray(info_indices, dtype=int)
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        while num_frames < max_frames and num_errors < min_errors:
            ...
            if crc_length > 0:
                frame_error = not np.array_equal(info_bits, decoded_info[:K_info])
            else:
                frame_error = not np.array_equal(payload, decoded_info)
