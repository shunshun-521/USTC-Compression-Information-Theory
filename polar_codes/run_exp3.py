...
from validate import run_unit_tests, quick_env
...
DESIGN_EBN0 = 2.5
MAX_ITER = 50
MAX_FRAMES = 1000 if quick_env() else 100000
MIN_ERRORS = 20 if quick_env() else 100
EB_N0_RANGE = np.arange(1.0, 5.5, 0.5 if quick_env() else 0.25)
