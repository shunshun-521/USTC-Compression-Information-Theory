...
def _unit_tests():
    u = np.array([1, 0, 1, 1])
    assert np.array_equal(polar_encode(u), (polar_generator_matrix(4) @ u) % 2)
...
DESIGN_EBN0 = 2.5
MAX_ITER = 50
MAX_FRAMES = 1500 if fast_sim_enabled() else 100000
MIN_ERRORS = 15 if fast_sim_enabled() else 100
