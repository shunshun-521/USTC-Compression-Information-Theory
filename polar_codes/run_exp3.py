...
for N in N_LIST:
    ...
    all_results['SC'] = r_sc
    save_results_csv(r_sc, os.path.join(os.path.dirname(__file__), f'results/exp3_sc_N{N}_R0.5.csv'))
    ...
    save_results_csv(r_scl, os.path.join(os.path.dirname(__file__), f'results/exp3_scl_N{N}_R0.5.csv'))
    ...
    save_results_csv(r_bp, os.path.join(os.path.dirname(__file__), f'results/exp3_bp_N{N}_R0.5.csv'))

    shannon_db = find_capacity_limit(RATE)
    plot_bler_curves(
        all_results,
        f'SC vs SCL vs BP (N={N}, R={RATE})',
        os.path.join(os.path.dirname(__file__), f'results/fig3_bp_N{N}_bler.png'),
    ...
    plt.tight_layout()
    base = os.path.join(os.path.dirname(__file__), f'results/fig3_bp_N{N}_iters')
