...
def main():
    ...
    for N in N_LIST:
        ...
        r_sc = run_simulation(N, K, EB_N0_RANGE,
        ...
        r_scl = run_simulation(N, K, EB_N0_RANGE,
                               lambda llr: (SCLDecoder(N, frozen_bits, list_size=4).decode(llr)[0], None),
        ...
        r_bp = run_simulation(N, K, EB_N0_RANGE,
