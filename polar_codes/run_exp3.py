...
from validate import test_encoder, test_sc_noiseless
...
N_LIST = [256] if FAST else [256, 512]
RATE = 0.5
DESIGN_EBN0 = 2.5
MAX_ITER = 50
...
for N in N_LIST:
    ...
    print(f"\n{'=' * 60}\n实验三 N={N}\n{'=' * 60}")
    r_sc = run_simulation(N, K, EB_N0_RANGE, sc_d, info_idx, "sc", MAX_FRAMES, MIN_ERRORS)
    all_results["SC"] = r_sc
    ...
    r_scl = run_simulation(N, K, EB_N0_RANGE, scl_d, info_idx, "scl", MAX_FRAMES, MIN_ERRORS)
    ...
    r_bp = run_simulation(N, K, EB_N0_RANGE, bp_d, info_idx, "bp", MAX_FRAMES, MIN_ERRORS)
