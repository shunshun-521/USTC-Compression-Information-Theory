...
DESIGN_EBN0 = 2.5
MAX_ITER = 50
MAX_FRAMES = 2000 if quick_mode() else 100000
MIN_ERRORS = 20 if quick_mode() else 100
EB_N0_RANGE = np.arange(2.0, 4.5, 0.5) if quick_mode() else np.arange(1.0, 5.5, 0.25)
