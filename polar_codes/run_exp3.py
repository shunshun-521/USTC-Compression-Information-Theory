...
from simulation import run_simulation, fast_sim_env
...
DESIGN_EBN0 = 2.5
MAX_ITER = 50
MAX_FRAMES = 5000 if fast_sim_env() else 100000
MIN_ERRORS = 20 if fast_sim_env() else 100
EB_N0_RANGE = np.arange(1.0, 5.5, 0.5) if fast_sim_env() else np.arange(1.0, 5.5, 0.25)
