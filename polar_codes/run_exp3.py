...
from test_units import test_encoder, test_sc_noiseless
...
DESIGN_EBN0 = 2.5
MAX_ITER = 50
MAX_FRAMES = quick_env_int("POLAR_MAX_FRAMES", 300 if QUICK else 100000)
MIN_ERRORS = quick_env_int("POLAR_MIN_ERRORS", 15 if QUICK else 100)
