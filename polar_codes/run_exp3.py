...
from validate import test_bp_runs, test_encoder, test_sc_lossless
...
from utils import find_capacity_limit, permute_llr_for_decode, plot_bler_curves, save_results_csv
...
for N in N_LIST:
    ...
    def sc_d(llr_ch):
        return sc_decode(permute_llr_for_decode(llr_ch), frozen_bits), None
    ...
    def scl_d(llr_ch):
        u, pm = SCLDecoder(N, frozen_bits, list_size=4).decode(
            permute_llr_for_decode(llr_ch)
        )
        return u, None
