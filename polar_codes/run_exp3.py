...
from test_units import run_all as run_unit_tests
...
_, MAX_FRAMES, MIN_ERRORS = get_sim_params()
...
for N in N_LIST:
    ...
    def scl_d(llr_ch):
        u, _ = SCLDecoder(N, frozen_bits, list_size=4, info_indices=info_idx).decode(
            llr_ch
        )
        return u, None
