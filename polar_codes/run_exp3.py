...
N_LIST = [128, 256] if QUICK else [256, 512]
RATE = 0.5
DESIGN_EBN0 = 2.5
MAX_ITER = 50
MAX_FRAMES = int(os.environ.get("POLAR_MAX_FRAMES", "1000" if QUICK else "100000"))
MIN_ERRORS = int(os.environ.get("POLAR_MIN_ERRORS", "30" if QUICK else "100"))
EB_N0_RANGE = np.arange(4.0, 10.5, 1.0 if QUICK else 0.25)
...
for N in N_LIST:
    ...
    if N == 256:
        import shutil
        shutil.copy(f"results/fig3_bp_N{N}_bler.png", "results/fig3_bp_bler.png")
        shutil.copy(f"results/fig3_bp_N{N}_bler.pdf", "results/fig3_bp_bler.pdf")
