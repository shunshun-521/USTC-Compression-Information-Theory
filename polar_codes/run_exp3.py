...
from validate import validate_encoder, validate_bp
...
if os.environ.get("POLAR_FAST_SIM"):
    N_LIST = [256]
    MAX_FRAMES = int(os.environ.get("POLAR_MAX_FRAMES", "1500"))
    MIN_ERRORS = int(os.environ.get("POLAR_MIN_ERRORS", "15"))
    stride = int(os.environ.get("POLAR_SNR_STRIDE", "2"))
    EB_N0_RANGE = EB_N0_RANGE[::stride]
