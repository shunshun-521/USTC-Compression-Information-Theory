...
N_LIST = cfg.EXP3_N_LIST
RATE = cfg.RATE
DESIGN_EBN0 = cfg.DESIGN_EBN0
MAX_ITER = 50
MAX_FRAMES = cfg.EXP3_MAX_FRAMES
MIN_ERRORS = cfg.EXP3_MIN_ERRORS
EB_N0_RANGE = (
    cfg.EXP3_EB_N0 if cfg.EXP3_EB_N0 is not None else np.arange(1.0, 5.5, 0.25)
)
