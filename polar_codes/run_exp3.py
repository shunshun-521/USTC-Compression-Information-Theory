...
DESIGN_EBN0 = 2.5
MAX_ITER = 50
MAX_FRAMES = 3000 if fast_sim_enabled() else 100000
MIN_ERRORS = 20 if fast_sim_enabled() else 100
EB_N0_RANGE = np.arange(1.0, 5.5, 0.5 if fast_sim_enabled() else 0.25)
...
for N in N_LIST:
    ...
    def bp_d(llr_ch):
        u_hat, num_iters = BPDecoder(N, frozen_bits, max_iter=MAX_ITER).decode(llr_ch)
