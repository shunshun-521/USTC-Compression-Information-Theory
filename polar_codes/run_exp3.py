...
def run_unit_tests():
    ...
    assert verify_sc_decoder(N=64, K=32, num_frames=100), "SC 译码校验失败"
    assert verify_scl_equals_sc(N=64, K=32, num_frames=20), "SCL L=1 路径度量校验失败"
    print("单元测试通过。")
...
MAX_FRAMES = 20000
MIN_ERRORS = 20
EB_N0_RANGE = np.arange(1.0, 9.5, 0.5)
