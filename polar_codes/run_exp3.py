...
from channel import bpsk_modulate, compute_llr, reorder_llr_for_decoder
...
def main():
    ...
    for N in N_LIST:
        ...
        r_sc = run_simulation(
            N, K, info_idx, EB_N0_RANGE, sc_d, "sc", max_frames, min_errors,
        )
        all_results["SC"] = r_sc
        ...
        r_scl = run_simulation(
            N, K, info_idx, EB_N0_RANGE, scl_d, "scl", max_frames, min_errors,
        )
        ...
        r_bp = run_simulation(
            N, K, info_idx, EB_N0_RANGE, bp_d, "bp", max_frames, min_errors,
        )
        ...
        plot_bler_curves(
            ...
            save_path=f"results/fig3_bp_N{N}_bler.png",
