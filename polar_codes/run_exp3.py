...
EB_N0_RANGE = np.arange(1.0, 2.5, 0.5) if QUICK else np.arange(1.0, 5.5, 0.25)
...
for N in N_LIST:
    ...
    def scl_d(llr_ch, _N=N, _fb=frozen_bits):
        u, pm = SCLDecoder(_N, _fb, list_size=4).decode(llr_ch)
        return u, None
