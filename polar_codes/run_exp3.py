...
for N in N_LIST:
    ...
    bp_iter = 8 if QUICK else MAX_ITER
    bp_decoder = BPDecoder(N, fb, max_iter=bp_iter)
...
# 合并图（规范 fig3_bp_bler.png）
if plt is not None and os.path.exists("results/fig3_bp_N256_bler.png"):
    import shutil
