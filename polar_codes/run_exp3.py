...
from validate import validate_encoder, validate_sc
...
N_LIST = [128, 256] if FAST else [256, 512]
RATE = 0.5
DESIGN_EBN0 = 2.5
MAX_ITER = 50
MAX_FRAMES = int(os.environ.get("POLAR_MAX_FRAMES", "2000" if FAST else "100000"))
MIN_ERRORS = int(os.environ.get("POLAR_MIN_ERRORS", "20" if FAST else "100"))
EB_N0_RANGE = np.arange(1.0, 5.5, 1.0 if FAST else 0.25)
