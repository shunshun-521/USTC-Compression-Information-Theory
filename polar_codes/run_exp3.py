...
for N in N_LIST:
    ...
    r_sc = run_simulation(
        N, K, EB_N0_RANGE, sc_d, info_idx, frozen_bits, "sc", MAX_FRAMES, MIN_ERRORS
    )
    all_results["SC"] = r_sc
    ...
    r_scl = run_simulation(
        N, K, EB_N0_RANGE, scl_d, info_idx, frozen_bits, "scl", MAX_FRAMES, MIN_ERRORS
    )
    ...
    r_bp = run_simulation(
        N, K, EB_N0_RANGE, bp_d, info_idx, frozen_bits, "bp", MAX_FRAMES, MIN_ERRORS
    )
