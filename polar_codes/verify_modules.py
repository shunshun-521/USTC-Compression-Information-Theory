...
from decoder_sc import sc_decode, sc_decode_with_br, sc_decode_recursive
...
def test_encoder():
    ...
    x_ref = (u @ G) % 2
    assert np.array_equal(x, x_ref), f"编码器与生成矩阵不一致: {x} != {x_ref}"
    print("encoder: OK")
...
def test_sc_recursive_match():
    ...
    for _ in range(20):
        ...
        u_rec = sc_decode_with_br(llr, frozen_bits)
