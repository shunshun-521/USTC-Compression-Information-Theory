...
_FAST = os.environ.get("POLAR_FAST_SIM", "").strip() in ("1", "true", "yes")
...
DESIGN_EBN0 = 2.5
CRC_LENGTH = 8
L_LIST = [2, 4] if _FAST else [2, 4, 8]
MAX_FRAMES = 100000
MIN_ERRORS = 100
EB_N0_RANGE = np.arange(1.0, 5.5, 1.0) if _FAST else np.arange(1.0, 5.5, 0.25)
