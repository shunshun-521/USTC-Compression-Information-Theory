...
settings = fast_sim_settings()
N = 128 if os.environ.get("POLAR_FAST_SIM") == "1" else 512
RATE = 0.5
K = N // 2
DESIGN_EBN0 = 2.5
CRC_LENGTH = 8
L_LIST = [2] if os.environ.get("POLAR_FAST_SIM") == "1" else [2, 4, 8]
RUN_CASCL = os.environ.get("POLAR_FAST_SIM") != "1"
MAX_FRAMES = settings["max_frames"]
MIN_ERRORS = settings["min_errors"]
EB_N0_RANGE = settings["eb_n0_other"]
...
results_sc = run_simulation(
    ...
    verbose=True, design_eb_n0_db=DESIGN_EBN0,
)
...
for L in L_LIST:
    ...
    results = run_simulation(
        ...
        MAX_FRAMES, MIN_ERRORS, verbose=True, design_eb_n0_db=DESIGN_EBN0,
    )
