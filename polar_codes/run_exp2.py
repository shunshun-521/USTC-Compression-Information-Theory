...
from test_units import test_encoder_roundtrip, test_sc_lossless, test_scl_equiv_sc
...
MAX_FRAMES = 100000
MIN_ERRORS = 100
EB_N0_RANGE = np.concatenate([np.arange(1.0, 5.5, 0.25), np.arange(6.0, 12.5, 0.5)])
