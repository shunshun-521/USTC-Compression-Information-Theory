...
MAX_FRAMES = int(os.environ.get("POLAR_MAX_FRAMES", "3000" if _QUICK else "100000"))
MIN_ERRORS = int(os.environ.get("POLAR_MIN_ERRORS", "15" if _QUICK else "100"))
...
EB_N0_RANGE = np.arange(1.0, 5.5, 0.5 if _QUICK else 0.25)
...
results_sc = run_simulation(
    N, K, EB_N0_RANGE, sc_decoder, info_idx, "sc",
...
for L in L_LIST:
    ...
    results = run_simulation(
        N, K, EB_N0_RANGE, scl_decoder, info_idx, "scl",
        MAX_FRAMES, MIN_ERRORS, verbose=True,
    )
