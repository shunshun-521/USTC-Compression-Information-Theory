...
EB_N0_RANGE = (
    np.arange(1.5, 4.0, 0.5) if QUICK else np.arange(1.0, 5.5, 0.25)
)
...
# 兼容目录规范：保存 exp2_scl_N512_R0.5.csv
if N == 512:
    save_results_csv(
        all_results.get("SCL (L=4)", results_sc), "results/exp2_scl_N512_R0.5.csv"
    )
