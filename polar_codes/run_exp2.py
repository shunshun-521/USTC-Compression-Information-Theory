...
def _run_unit_tests():
    ...
    from validate import test_scl_l1_equals_sc
...
MAX_FRAMES = 1000 if FAST else 100000
MIN_ERRORS = 10 if FAST else 100
EB_N0_RANGE = np.arange(6.0, 10.5, 1.0) if FAST else np.arange(4.0, 11.0, 0.25)
...
if __name__ == "__main__":
    ...
    for L in L_LIST:
        ...
        def scl_decoder(llr_ch, _dec=scl_inst):
    ...
    def cascl_decoder(llr_ch):
        u_hat, pm = cascl_inst.decode(llr_ch)
        return u_hat, None
