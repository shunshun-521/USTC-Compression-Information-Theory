...
from simulation import get_sim_limits, run_simulation
from utils import find_capacity_limit, plot_bler_curves, save_results_csv

from validate import test_encoder, test_scl_equiv_sc

test_encoder()
test_scl_equiv_sc(N=64, K=32, num_frames=10)
print("单元测试通过。\n")
...
CRC_LENGTH = 8
L_LIST = [2, 4, 8]
MAX_FRAMES, MIN_ERRORS = get_sim_limits()
