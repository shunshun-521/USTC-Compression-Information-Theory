...
N = 128 if quick_mode() else 512
RATE = 0.5
K = N // 2
DESIGN_EBN0 = 2.5
CRC_LENGTH = 8
L_LIST = [2, 4] if quick_mode() else [2, 4, 8]
MAX_FRAMES = 500 if quick_mode() else 100000
MIN_ERRORS = 5 if quick_mode() else 100
EB_N0_RANGE = np.arange(2.0, 3.5, 0.5) if quick_mode() else np.arange(1.0, 5.5, 0.25)
