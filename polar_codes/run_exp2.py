...
def run_unit_tests():
    ...
    verify_scl_equals_sc(N=64, K=32)
...
def sc_decoder(llr_ch):
    return sc_decode(channel_llr_for_decode(llr_ch), frozen_bits), None
...
results_cascl = run_simulation(
    ...
    crc_length=CRC_LENGTH, verbose=True, info_indices=info_idx,
)
