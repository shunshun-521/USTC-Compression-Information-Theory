...
from simulation import run_simulation, fast_eb_n0_range, fast_exp2_params
...
CRC_LENGTH = 8
L_LIST = [2, 4, 8]
N, L_LIST = fast_exp2_params(N, L_LIST)
K = N // 2
MAX_FRAMES = 100000
MIN_ERRORS = 100
EB_N0_RANGE = fast_eb_n0_range(np.arange(1.0, 5.5, 0.25))
...
if os.environ.get("POLAR_FAST_SIM", "").strip() not in ("1", "true", "yes"):
