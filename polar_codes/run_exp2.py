...
def run_unit_tests():
    ...
    for _ in range(50):
        ...
        if not np.array_equal(u_sc[info_idx], u_scl[info_idx]):
            mismatches += 1
...
results_sc = run_simulation(
    ...
    MAX_FRAMES, MIN_ERRORS, info_indices=info_idx, frozen_bits=frozen_bool,
)
...
results_cascl = run_simulation(
    ...
    info_indices=info_idx, frozen_bits=frozen_bool,
)
