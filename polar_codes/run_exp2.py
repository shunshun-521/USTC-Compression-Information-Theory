...
from validate import test_encoder, test_sc_noiseless, test_scl_equiv_sc
...
from simulation import run_simulation, fast_sim_settings
...
fast = fast_sim_settings()
if fast:
    MAX_FRAMES = fast['max_frames']
    MIN_ERRORS = fast['min_errors']
    EB_N0_RANGE = fast['eb_n0_range_other']
    L_LIST = [2, 4]
