...
from channel import bpsk_modulate, compute_llr, llr_for_sc_decoder
...
def run_unit_tests():
    from run_exp1 import run_unit_tests as base_tests
    ...
    llr = llr_for_sc_decoder(compute_llr(bpsk_modulate(polar_encode(u)), 0.01))
...
EB_N0_RANGE = np.arange(1.0, 5.5, 0.5 if FAST else 0.25)
