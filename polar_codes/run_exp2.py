...
from validate import test_encoder, test_sc_noiseless, test_scl_l1_equals_sc, test_crc
...
EB_N0_RANGE = np.array([2.0, 3.0, 4.0]) if FAST else np.arange(1.0, 5.5, 0.25)
...
# 兼容目录规范中的 exp2_scl_N512_R0.5.csv
...
ax.bar(labels, avg_times, color="steelblue")
