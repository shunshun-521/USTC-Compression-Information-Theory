...
from channel import eb_n0_to_sigma, bpsk_modulate, compute_llr, awgn_channel
...
EB_N0_RANGE = (
    np.arange(1.0, 3.5, 0.5) if _QUICK else np.arange(1.0, 5.5, 0.25)
)
