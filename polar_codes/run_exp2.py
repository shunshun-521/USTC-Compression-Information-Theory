...
DESIGN_EBN0 = 2.5
CRC_LENGTH = 8
L_LIST = [2, 4, 8] if not FAST else [2, 4]
MAX_FRAMES = 100000 if not FAST else 200
MIN_ERRORS = 100 if not FAST else 10
EB_N0_RANGE = np.arange(1.0, 5.5, 0.25) if not FAST else np.arange(2.0, 3.5, 0.5)
RUN_CASCL = not FAST
