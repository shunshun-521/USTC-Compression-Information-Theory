...
def _unit_tests():
    ...
    verify_scl_equals_sc(N=32, K=16)
...
if __name__ == "__main__":
    ...
    results_sc = run_simulation(
        N, K, EB_N0_RANGE, sc_decoder, "sc", MAX_FRAMES, MIN_ERRORS, info_idx=info_idx
    )
    ...
    for L in L_LIST:
        ...
        results = run_simulation(
            N, K, EB_N0_RANGE, scl_decoder, "scl", MAX_FRAMES, MIN_ERRORS, info_idx=info_idx
        )
