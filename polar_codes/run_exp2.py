...
from exp_config import MAX_FRAMES, MIN_ERRORS, EB_N0_RANGE_EXP23, L_LIST_EXP2, CASCL_LIST_SIZE
...
CRC_LENGTH = 8
L_LIST = L_LIST_EXP2
EB_N0_RANGE = EB_N0_RANGE_EXP23 if EB_N0_RANGE_EXP23 is not None else np.arange(1.0, 5.5, 0.25)
