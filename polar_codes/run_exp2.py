...
verify_sc_decoder(N=64, K=32, num_frames=50, eb_n0_db=10.0)
verify_scl_equals_sc(N=64, K=32, eb_n0_db=5.0, num_frames=20)
print("单元测试通过\n")
...
results_sc = run_simulation(
    ...
    frozen_bits=frozen_bool, info_indices=info_idx,
)
