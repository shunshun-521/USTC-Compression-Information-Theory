...
results_sc = run_simulation(
    N, K, EB_N0_RANGE, sc_decoder, "sc", MAX_FRAMES, MIN_ERRORS, frozen_bits=frozen_bits
)
...
for L in L_LIST:
    ...
    results = run_simulation(
        N, K, EB_N0_RANGE, scl_decoder, "scl", MAX_FRAMES, MIN_ERRORS, frozen_bits=frozen_bits
    )
...
save_results_csv(
    all_results["SCL (L=8)"],
    f"results/exp2_scl_N{N}_R0.5.csv",
)
