...
RUN_VALIDATE = os.environ.get("POLAR_RUN_VALIDATE", "1") == "1"
...
MAX_FRAMES = int(os.environ.get("POLAR_MAX_FRAMES", "100000" if not FAST else "100"))
MIN_ERRORS = int(os.environ.get("POLAR_MIN_ERRORS", "100" if not FAST else "3"))
EB_N0_RANGE = np.arange(2.0, 4.5, 1.0 if FAST else 0.25)
