...
MAX_FRAMES = 30 if QUICK else 100000
MIN_ERRORS = 5 if QUICK else 100
EB_N0_RANGE = (
    np.array([2.0, 3.0]) if QUICK else np.arange(1.0, 5.5, 0.25)
)

if __name__ == "__main__":
    print("=" * 60)
    print("实验二：SCL / CA-SCL 译码仿真")
    print("=" * 60)
    run_all_tests()
    ...
    if not QUICK:
        ...
        save_results_csv(
            results_cascl, f"results/exp2_cascl_L8_N{N}_R0.5.csv"
        )
