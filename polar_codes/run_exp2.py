...
from verify import quick_params, run_unit_tests
...
CRC_LENGTH = 8
L_LIST = [2, 4, 8]
MAX_FRAMES, MIN_ERRORS, EB_N0_RANGE = quick_params(
    100000, 100, np.arange(1.0, 5.5, 0.25)
)
...
for L in L_LIST:
    ...
    if L == 4:
        shutil.copy(f"results/exp2_scl_L{L}_N{N}_R0.5.csv", f"results/exp2_scl_N{N}_R0.5.csv")
