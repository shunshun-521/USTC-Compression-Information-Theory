...
MAX_FRAMES = int(os.environ.get("POLAR_MAX_FRAMES", "500" if FAST else "100000"))
MIN_ERRORS = int(os.environ.get("POLAR_MIN_ERRORS", "5" if FAST else "100"))
RUN_VALIDATE = os.environ.get("POLAR_RUN_VALIDATE", "1" if not FAST else "0") == "1"
