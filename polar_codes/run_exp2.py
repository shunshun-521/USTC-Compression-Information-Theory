...
def run_unit_tests():
    ...
    for _ in range(20):
        ...
        llr = compute_llr(bpsk_modulate(polar_encode(u)) + rng.normal(0, 0.05, N), 0.05)
...
if __name__ == '__main__':
    ...
    CRC_LENGTH = 8
    L_LIST = [2, 4, 8]
    MAX_FRAMES = int(os.environ.get('POLAR_MAX_FRAMES', '10000'))
    MIN_ERRORS = int(os.environ.get('POLAR_MIN_ERRORS', '50'))
