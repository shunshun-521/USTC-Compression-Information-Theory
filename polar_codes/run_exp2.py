...
from exp_common import POLAR_QUICK, run_unit_tests
...
CRC_LENGTH = 8
L_LIST = [2, 4, 8]
MAX_FRAMES = 500 if POLAR_QUICK else 100000
MIN_ERRORS = 10 if POLAR_QUICK else 100
EB_N0_RANGE = np.arange(1.0, 2.5, 0.5) if POLAR_QUICK else np.arange(1.0, 5.5, 0.25)
