...
if __name__ == '__main__':
    ...
    print(f"\nSC 基线仿真: N={N}, K={K}")
    results_sc = run_simulation(N, K, EB_N0_RANGE, sc_decoder, 'sc',
    ...
    for L in L_LIST:
        ...
        results = run_simulation(N, K, EB_N0_RANGE, scl_decoder, 'scl',
                                 MAX_FRAMES, MIN_ERRORS, info_indices=info_idx, verbose=True)
        label = f'SCL (L={L})'
    ...
    results_cascl = run_simulation(N, K, EB_N0_RANGE, cascl_decoder, 'scl',
