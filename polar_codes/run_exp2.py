...
results_sc = run_simulation(
    N, K, EB_N0_RANGE, sc_decoder, "sc", MAX_FRAMES, MIN_ERRORS, frozen_bits=frozen_bits, info_indices=info_idx
)
...
for L in L_LIST:
    ...
    results = run_simulation(
        N, K, EB_N0_RANGE, scl_decoder, "scl", MAX_FRAMES, MIN_ERRORS, frozen_bits=frozen_bits, info_indices=info_idx
    )
