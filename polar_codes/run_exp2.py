...
from decoder_scl import SCLDecoder, crc_encode, crc_check, validate_scl_equals_sc
...
def run_unit_tests():
  ...
  assert validate_sc_decoder(N=64, K=32, num_frames=50, eb_n0_db=10.0)
  assert validate_scl_equals_sc(N=64, K=32, num_frames=20, eb_n0_db=5.0)
