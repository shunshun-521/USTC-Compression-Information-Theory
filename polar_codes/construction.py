...
if __name__ == "__main__":
    info_8, frozen_8, _ = ga_construction(8, 4, 2.5)
    print("N=8, K=4, Eb/N0=2.5dB")
    print("info_indices:", info_8)
    print("frozen_indices:", frozen_8)

    info_256, _, _ = ga_construction(256, 128, 2.5)
    print("\nN=256, K=128, info_indices (first 20):", info_256[:20])
