...
def _bpsk_mutual_information(eb_n0_linear):
    """BPSK-AWGN 互信息（bits/channel use），Eb/N0 为线性值。"""

    def integrand(t):
        pdf = np.exp(-t ** 2) / np.sqrt(np.pi)
        return pdf * np.log2(1.0 + np.exp(-2.0 * eb_n0_linear * t ** 2))
...
def compute_bpsk_capacity(eb_n0_db_list, rate):
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        capacities.append(_bpsk_mutual_information(eb_lin))
