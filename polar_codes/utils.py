...
def compute_bpsk_capacity(eb_n0_db_list, rate):
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        hy, _ = integrate.quad(entropy_integrand, -12.0, 12.0, limit=200)
        h_noise = 0.5 * np.log2(2.0 * np.pi * np.e * sigma2)
        capacities.append(max(0.0, hy - h_noise))
