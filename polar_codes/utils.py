...
def plot_bler_curves(results_dict, title, save_path, shannon_limit_db=None,
    ...
    for label, results in results_dict.items():
        eb_vals = [r['eb_n0_db'] for r in results]
        blers = [max(r['bler'], 1e-7) for r in results]
        ax.semilogy(eb_vals, blers, 'o-', label=label, markersize=4)
