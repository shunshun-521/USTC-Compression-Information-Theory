...
def compute_bpsk_capacity(eb_n0_db_list, rate):
    ...
    C = 1 - E_{y}[log2(1 + e^{-2*gamma*y})]，gamma = Es/N0 = R * Eb/N0（线性）
    """
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        def integrand(y):
            log_term = np.logaddexp(0.0, -2.0 * gamma * y) / np.log(2.0)
...
def find_capacity_limit(rate, eb_n0_range=(-2, 6), num_points=1000):
    ...
    gamma_lin = (2 ** (2 * rate) - 1) / (2 * rate)
    return 10.0 * np.log10(gamma_lin)
