...
def bpsk_capacity_per_use(eb_n0_db, rate):
...
def compute_bpsk_capacity(eb_n0_db_list, rate):
    ...
    return [bpsk_capacity_per_use(e, rate) for e in eb_n0_db_list]
...
def find_capacity_limit(rate, eb_n0_range=(-5, 20), num_points=1000):
    ...
    caps = np.array([bpsk_capacity_per_use(e, rate) for e in grid])
