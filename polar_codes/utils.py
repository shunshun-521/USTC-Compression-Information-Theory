...
def compute_bpsk_capacity(eb_n0_db_list, rate):
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        def h_cond(x_bit):
            ...
            val, _ = integrate.quad(integrand, -12.0, 12.0)
            return val
        ...
        hy, _ = integrate.quad(hy_integrand, -12.0, 12.0)
        hyx = 0.5 * h_cond(0) + 0.5 * h_cond(1)
        capacities.append(hy - hyx)
    return np.array(capacities)


def find_capacity_limit(rate, eb_n0_range=(-3, 3), num_points=2000):
