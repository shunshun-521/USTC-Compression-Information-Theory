...
def _bpsk_mi(eb_n0_lin, rate):
    """BPSK-AWGN 互信息（bits/channel use），与仿真信道模型一致"""
    ...
    def p_y(y):
        ...
        return 0.5 * norm * (np.exp(-((y - 1.0) ** 2) / (2.0 * var))
    ...
    h_y, _ = integrate.quad(integrand, -15.0, 15.0, limit=200)
...
def compute_bpsk_capacity(eb_n0_db_list, rate):
    ...
    for eb_n0_db in eb_n0_db_list:
        ...
        capacities.append(_bpsk_mi(eb_lin, rate))
