...
def _bpsk_capacity_per_eb_n0(eb_n0_db, rate):
    """BPSK 容量（bits/channel use）对给定 Eb/N0"""
...
def compute_bpsk_capacity(eb_n0_db_list, rate):
    """计算 BPSK 信道容量列表"""
    return [_bpsk_capacity_per_eb_n0(e, rate) for e in eb_n0_db_list]
...
def find_capacity_limit(rate, eb_n0_range=(-5, 20), num_points=1000):
    ...
    caps = np.array([_bpsk_capacity_per_eb_n0(e, rate) for e in grid])
