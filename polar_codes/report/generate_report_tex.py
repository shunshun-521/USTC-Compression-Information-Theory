...
def sync_figures():
    """将 results/ 中的 PDF 图表同步到 report/figures/（便于 LaTeX 引用）。"""
    import shutil
    ...
    names = [
        "fig1_sc_bler.pdf",
        "fig2_scl_bler.pdf",
        "fig2_decode_time.pdf",
        "fig3_bp_N256_bler.pdf",
        "fig3_bp_N256_iters.pdf",
        "fig3_bp_N512_bler.pdf",
        "fig3_bp_N512_iters.pdf",
    ]
    for name in names:
