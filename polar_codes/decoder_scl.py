...
from decoder_sc import (
    f_operation, g_operation, active_llr_level, active_bit_level, _prepare_channel_llr
)
...
class SCLDecoder:
    ...
    def decode(self, llr_ch):
        ...
        if self.crc_length > 0:
            ...
            crc_pass = [p for p, u in zip(paths, u_candidates) if crc_check(u, self.crc_length)]
...
if __name__ == "__main__":
    ...
    print(f"SCL L=1 vs SC 一致性: {50 - mismatches}/50")
