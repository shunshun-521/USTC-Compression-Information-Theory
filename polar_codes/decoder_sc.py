"""
极化码 SC（串行抵消）译码器
提供递归版本（参考实现）和非递归 Permuted SCD（高效实现，与蝶形编码器配对）
"""
import math
...
def sc_decode(llr_ch, frozen_bits):
    """
    非递归 Permuted SCD 译码（与蝶形 XOR 编码器配对）。
