...
def sc_decode_recursive(llr, frozen_bits):
    ...
    llr_perm = llr[decode_order]
    frozen_perm = frozen_bits[decode_order]
...
def precompute_sc_indices(N):
    ...
    return decode_order, lambda_offset, llr_layer_vec, bit_layer_vec


def sc_decode(llr_ch, frozen_bits):
    """
    非递归 SC 译码（置换序 SC，与 polar_encode 配套）。
    """
