...
def precompute_sc_indices(N):
    ...
    """
    n = int(np.log2(N))
    phase_order = np.array([_bit_reversed(i, n) for i in range(N)], dtype=int)
    ...
    return phase_order, lambda_offset, llr_layer_vec, bit_layer_vec
